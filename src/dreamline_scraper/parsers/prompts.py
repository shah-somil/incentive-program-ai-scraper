...
SYSTEM_PROMPT = (
    ...
    "For application_url, include only absolute https:// links that appear "
    "verbatim in the content. If the page has no direct application or program "
    "URL, leave application_url null — the pipeline will use the source page. "
    "Never invent paths or guess URLs. "
